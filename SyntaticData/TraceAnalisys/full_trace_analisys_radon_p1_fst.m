...
load('CaseData1_0/full_radon_trace_CaseData1_0.mat')
...
figure(2)
imagesc(q, time, traces_matrix_prim, [-1 1]*1e-5)
...
figure(6)
imagesc(q, time, deconvolved_matrix, [-1 1]*1e-5)
...
figure(7)
imagesc(h(min_offset_idx:end), time, primaries_time(:, 1:end-min_offset_idx), [-1 1]*1e-3)
...
figure(8)
imagesc(h(min_offset_idx:end), time, primaries_multiples_time(:, 1:end-min_offset_idx), [-1 1]*1e-3)
...
figure(9)
imagesc(h(min_offset_idx:end), time, filtered_traces_time(:, 1:end-min_offset_idx), [-1 1]*1e-3)
...
figure(10)
imagesc(h(min_offset_idx:end), time, primaries_time_nmo, [-1 1]*8e-4)
...
figure(11)
imagesc(h(min_offset_idx:end), time, primaries_multiples_elm_time_nmo, [-1 1]*8e-4)
...
figure(12)
imagesc(h(min_offset_idx:end), time, filtered_traces_elm_time_nmo, [-1 1]*8e-4)
...
figure(14)
imagesc(q, time, deconvolved_matrix_fir, [-1 1]*1e-5)
...
figure(15)
imagesc(h(min_offset_idx:end), time, primaries_time(:, 1:end-min_offset_idx), [-1 1]*2e-3)
title('Radon inverted primaries in time')
axis([h(min_offset_idx) h(500) 0 time(1000)])
xlabel('offset [m]')
ylabel('time [s]')
...
figure(16)
imagesc(h(min_offset_idx:end), time, primaries_multiples_time(:, 1:end-min_offset_idx), [-1 1]*2e-3)
title('Radon inverted primaries and multiples in time')
axis([h(min_offset_idx) h(500) 0 time(1000)])
xlabel('offset [m]')
ylabel('time [s]')
...
figure(17)
imagesc(h(min_offset_idx:end), time, filtered_traces_time_fir(:, 1:end-min_offset_idx), [-1 1]*2e-3)
title('Inverted filtered trace in time domain - FIR')
axis([h(min_offset_idx) h(500) 0 time(1000)])
xlabel('offset [m]')
ylabel('time [s]')
...
figure(18)
imagesc(h(min_offset_idx:end), time, filtered_traces_fir_time_nmo(:, 1:end-min_offset_idx), [-1 1]*2e-3)
...
figure(20)
imagesc(q, time, deconvolved_matrix_esn, [-1 1]*1e-5)
...
figure(24)
imagesc(h(min_offset_idx:end), time, filtered_traces_esn_time_nmo(:, 1:end-min_offset_idx), [-1 1]*1e-3)
...
figure(25)
imagesc(h(min_offset_idx:end), time, filtered_traces_time(:, 1:end-min_offset_idx), [-1 1]*2e-3)
...
figure(27)
imagesc(h(min_offset_idx:end), time, filtered_traces_time_esn(:, 1:end-min_offset_idx), [-1 1]*2e-3)
...
figure(29)
imagesc(h(min_offset_idx:end), time, filtered_traces_elm_time_nmo(:, 1:end-min_offset_idx), [-1 1]*2e-3)
...
figure(31)
imagesc(h(min_offset_idx:end), time, filtered_traces_esn_time_nmo(:, 1:end-min_offset_idx), [-1 1]*2e-3)
...
figure(32)
imagesc(h(min_offset_idx:end), time, primaries_time_nmo(:, 1:end-min_offset_idx), [-1 1]*2e-3)
...
figure(44)
imagesc(h(min_offset_idx:end), time, repmat(stacked_filtered_traces_fir_time_nmo, 1, 500), [-1 1]*6e-2)
...
figure(45)
imagesc(h(min_offset_idx:end), time, repmat(stacked_filtered_traces_esn_time_nmo, 1, 500), [-1 1]*6e-2)
...
figure(46)
imagesc(h(min_offset_idx:end), time, repmat(stacked_filtered_traces_elm_time_nmo, 1, 500), [-1 1]*6e-2)
